...
public class GameBoard extends GridPane {
  ...
  /**
   * Handles when a specified block is right clicked.
   */
  private RightClickedListener rightClickListener;
  ...
  protected GameBlock createBlock(int x, int y) {
    ...
    //Make a hover effect
    block.setOnMouseEntered((mouseEvent) -> hover(block));

    //Remove hover effect
    block.setOnMouseExited((mouseEvent) -> block.hover(false));
  ...
  private void blockClicked(MouseEvent event, GameBlock block) {
    ...
    if (event.getButton().equals(MouseButton.SECONDARY)) {
      if (rightClickListener != null) {
        rightClickListener.setOnRightClicked();
      }
    }
  }
   ...
   * fade out effect.
   *
   * @param coordinates coordinates of the blocks to be faded out (cleared).
   */
  ...
  /**
   * Listens to right clicks.
   * @param rightClickedListener listener
   */
